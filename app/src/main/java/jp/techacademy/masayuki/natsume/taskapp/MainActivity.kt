...
const val EXTRA_TASK = "Jp.techacademy.masayuki.natsume.taskapp.TASK" //他ｱﾌﾟﾘのEXTRAと間違えない為に定義
...
class MainActivity : AppCompatActivity() {
    ...
    private val mRealmListener = object : RealmChangeListener<Realm> { //追加･削除に呼ばれるListener
        override fun onChange(element: Realm) {           //ﾒｯｿﾄﾞをｵｰﾊﾞｰﾗｲﾄﾞ してreloadを呼び出す
            reloadListView()           //ListViewの更新ﾒｯｿｯﾄﾞ
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->           //fab
